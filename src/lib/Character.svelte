<script lang="ts">
  ...
  const character = cva(
    "shadow-lg flex justify-center border text-white px-2 py-4 w-8 md:w-9 text-lg rounded-sm font-bold relative cursor-pointer",
    {
      variants: {
        intent: {
          unused: "border-gray-300 bg-gray-300 text-black",
          correct: "border-green-600 bg-green-600",
          incorrect: "border-gray-800 bg-gray-800",
          wrongPosition: "border-yellow-500 bg-yellow-500",
        },
      },
    }
  );
